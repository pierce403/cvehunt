...
- read `model_attempt/metadata.json`, `model_attempt/extracted.json`, `model_attempt/prompt.md`, `model_attempt/response.md`, and any extracted files such as `notes.md`, `fix.patch`, `poc.py`, or `refusal.md` to verify the external model invocation when present
