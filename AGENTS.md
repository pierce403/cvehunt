...
- Use `uv run cvehunt run CVE-2025-55182 --persist --json --model <model-label>` when comparing models. Reports include `Run ID` and `Model`; the current synthetic fixture workflow reaches `defensive_signal_observed` at 0.82 confidence.
